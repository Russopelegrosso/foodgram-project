...
def recipe_new(request):
    ...
    return render(request, 'recipes/formRecipe.html', context={'form': form})
...
def purchases(request):
    ...
    recipes = request.user.user_purchase_list.all()
    return render(
        request,
...
def purchases_download(request):
    ...
    ingredients = request.user.user_purchase_list.select_related(
        'recipe'
    ).order_by(
